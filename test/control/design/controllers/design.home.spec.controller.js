describe('Unit : simpleSliderPluginDesign design.home.controller.js', function () {
    var $scope, DesignHome, $rootScope, q, $controller, Buildfire, TAG_NAMES, $timeout,Datastore;
    beforeEach(module('simpleSliderPluginDesign'));
    ...
    describe('Unit : DataStore Factory returning error of datastore.get inside init', function () {
        ...
        beforeEach(function () {
            ...
            inject(function ($injector, $q) {
                ...
                $scope = $rootScope.$new();
                ContentHome = $injector.get('$controller')('DesignHomeCtrl', {
                    $scope: $scope,
                    TAG_NAMES: TAG_NAMES,
                    Buildfire: Buildfire,
                    Datastore:Datastore
